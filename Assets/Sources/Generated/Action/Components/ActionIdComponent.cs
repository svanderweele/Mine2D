...
public partial class ActionEntity {
    ...
    public svanderweele.Mine.Game.Components.Id.IdComponent id { get { return (svanderweele.Mine.Game.Components.Id.IdComponent)GetComponent(ActionComponentsLookup.Id); } }
