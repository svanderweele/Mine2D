...
public partial class GridEntity {
    ...
    public svanderweele.Mine.Game.Components.Grid.GridSizeComponent gridSize { get { return (svanderweele.Mine.Game.Components.Grid.GridSizeComponent)GetComponent(GridComponentsLookup.GridSize); } }
    ...
    public void AddGridSize(int newColumns, int newRows) {
        ...
        var component = CreateComponent<svanderweele.Mine.Game.Components.Grid.GridSizeComponent>(index);
