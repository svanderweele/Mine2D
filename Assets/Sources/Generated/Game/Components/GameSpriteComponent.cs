...
public partial class GameEntity {
    ...
    public svanderweele.Core.Pieces.Sprite.SpriteComponent sprite { get { return (svanderweele.Core.Pieces.Sprite.SpriteComponent)GetComponent(GameComponentsLookup.Sprite); } }
    ...
    public void AddSprite(string newName) {
        ...
        var component = CreateComponent<svanderweele.Core.Pieces.Sprite.SpriteComponent>(index);
