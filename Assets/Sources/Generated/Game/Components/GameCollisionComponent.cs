...
public partial class GameEntity {
    ...
    public svanderweele.Core.Pieces.Collision.Components.CollisionComponent collision { get { return (svanderweele.Core.Pieces.Collision.Components.CollisionComponent)GetComponent(GameComponentsLookup.Collision); } }
    ...
    public void AddCollision(System.Collections.Generic.List<int> newCollisions) {
        ...
        var component = CreateComponent<svanderweele.Core.Pieces.Collision.Components.CollisionComponent>(index);
