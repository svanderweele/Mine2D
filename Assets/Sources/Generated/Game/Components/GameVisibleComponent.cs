...
public partial class GameEntity {
    ...
    public svanderweele.Core.Pieces.Visible.VisibleComponent visible { get { return (svanderweele.Core.Pieces.Visible.VisibleComponent)GetComponent(GameComponentsLookup.Visible); } }
    ...
    public void AddVisible(bool newIsVisible) {
        ...
        var component = CreateComponent<svanderweele.Core.Pieces.Visible.VisibleComponent>(index);
