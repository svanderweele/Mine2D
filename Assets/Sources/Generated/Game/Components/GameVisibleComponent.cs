...
public partial class GameEntity {
    ...
    public svanderweele.Mine.Core.Pieces.Visible.VisibleComponent visible { get { return (svanderweele.Mine.Core.Pieces.Visible.VisibleComponent)GetComponent(GameComponentsLookup.Visible); } }
    ...
    public void AddVisible(bool newIsVisible) {
        ...
        var component = CreateComponent<svanderweele.Mine.Core.Pieces.Visible.VisibleComponent>(index);
