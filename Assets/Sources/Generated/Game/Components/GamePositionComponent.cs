...
public partial class GameEntity {
    ...
    public svanderweele.Core.Pieces.Spatial.PositionComponent position { get { return (svanderweele.Core.Pieces.Spatial.PositionComponent)GetComponent(GameComponentsLookup.Position); } }
    ...
    public void AddPosition(float newX, float newY) {
        ...
        var component = CreateComponent<svanderweele.Core.Pieces.Spatial.PositionComponent>(index);
        component.x = newX;
        component.y = newY;
