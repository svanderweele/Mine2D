...
public partial class GameEntity {
    ...
    public svanderweele.Core.Pieces.Grid.Core.Components.GridLayerComponent gridLayer { get { return (svanderweele.Core.Pieces.Grid.Core.Components.GridLayerComponent)GetComponent(GameComponentsLookup.GridLayer); } }
    ...
    public void AddGridLayer(int newLayer) {
        ...
        var component = CreateComponent<svanderweele.Core.Pieces.Grid.Core.Components.GridLayerComponent>(index);
